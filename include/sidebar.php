...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="assets/img/img_properties/logoo.JPG" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">DAP</span>
  </a>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <div class="bg-success nav-link text-white">
            ...
            <p>
              Sisa Uang: <?= number_format($jml_uang_kas - $jml_pengeluaran + 1920000); ?>
            </p>
          </div>
        </li>
        <li class="nav-item has-treeview menu-open">
