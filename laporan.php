        ...
        <?php if (isset($_POST['btnLaporanPemasukkan'])): ?>
        	...
        	<div class="row m-1">
	        	<div class="col-lg m-1">
	        		...
	        		<h3 class="text-left mb-3">Laporan Pada Bulan: <?= ucwords($fetch_sql['nama_bulan']); ?>, Tahun: <?= $fetch_sql['tahun']; ?>, Pembayaran Perbulan: Rp. <?= number_format($fetch_sql['pembayaran_perminggu']); ?></h3>
