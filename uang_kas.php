    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row justify-content-center mb-2">
          <div class="col-sm">
            <h1 class="m-0 text-dark">Dana DAP</h1>
          </div><!-- /.col -->
                  ...
                  <form method="post">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          <label for="pembayaran_perminggu">Pembayaran Perbulan</label>
        ...
        <div class="row">
          <?php foreach ($bulan_pembayaran as $dbp): ?>
            <?php 
              ...
              $total_dana_dap_bulan_ini = mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(minggu_ke_1 + minggu_ke_2 + minggu_ke_3 + minggu_ke_4) as total_dana_dap_bulan_ini FROM uang_kas WHERE id_bulan_pembayaran = '$id_bulan_pembayaran'"));
              $total_dana_dap_bulan_ini = $total_dana_dap_bulan_ini['total_dana_dap_bulan_ini'];
            ?>
            <div class="col-lg-3">
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <h6>Total Dana DAP Bulan Ini: <span class="my-2 btn btn-success">Rp. <?= number_format($total_dana_dap_bulan_ini); ?></span></h6>
                      ...
                      <form method="post">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label for="pembayaran_perminggu<?= $dbp['id_bulan_pembayaran']; ?>">Pembayaran Perbulan</label>
