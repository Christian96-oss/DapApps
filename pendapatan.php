...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm text-right">
            <?php if ($_SESSION['id_jabatan'] !== '3'): ?>
              <button class="btn btn-primary" data-toggle="modal" data-target="#tambahPengeluaranModal"><i class="fas fa-fw fa-plus"></i> Tambah Pendapatan</button>
              <!-- Modal -->
                  ...
                  <form method="post">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="tambahPengeluaranModalLabel">Tambah Pendapatan</h5>
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          <label for="jumlah_pengeluaran">Jumlah Pendapatan</label>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 Kami</strong>
    All rights reserved.
